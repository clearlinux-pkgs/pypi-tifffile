...
Version  : 2022.8.12
Release  : 39
URL      : https://files.pythonhosted.org/packages/96/e9/bc14577c801e0e65c6369288b02cc8e553bef783b55d7c7b7159d8051fc6/tifffile-2022.8.12.tar.gz
...
%prep
%setup -q -n tifffile-2022.8.12
cd %{_builddir}/tifffile-2022.8.12
pushd ..
cp -a tifffile-2022.8.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1660518459
