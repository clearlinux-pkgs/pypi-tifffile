...
Source0  : https://files.pythonhosted.org/packages/37/c9/fc4e490c5b0ccad68c98ea1d6e0f409bd7d50e2e8fc30a0725594d3104ff/tifffile-2024.12.12.tar.gz
...
%prep
%setup -q -n tifffile-2024.12.12
cd %{_builddir}/tifffile-2024.12.12
pushd ..
cp -a tifffile-2024.12.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735099609
