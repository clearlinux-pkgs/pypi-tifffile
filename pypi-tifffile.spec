...
Source0  : https://files.pythonhosted.org/packages/ed/b2/2f8bb8896ef23f302958fb7580ebea9f6262c8b4b7c06f13ea7446f40253/tifffile-2022.7.28.tar.gz
...
%prep
%setup -q -n tifffile-2022.7.28
cd %{_builddir}/tifffile-2022.7.28
pushd ..
cp -a tifffile-2022.7.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659108219
