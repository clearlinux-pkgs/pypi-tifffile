...
Source0  : https://files.pythonhosted.org/packages/d1/54/e627e6604700d5ec694b023ae971a5493560452fe062d057dba1db23ac82/tifffile-2024.2.12.tar.gz
...
%prep
%setup -q -n tifffile-2024.2.12
cd %{_builddir}/tifffile-2024.2.12
pushd ..
cp -a tifffile-2024.2.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707839202
