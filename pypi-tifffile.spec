...
Version  : 2023.2.27
Release  : 47
URL      : https://files.pythonhosted.org/packages/5a/f7/734344b6421754dd10bdc5c1dc79ecb1b93b69bfa58dbe554a5fe1e4156c/tifffile-2023.2.27.tar.gz
Source0  : https://files.pythonhosted.org/packages/5a/f7/734344b6421754dd10bdc5c1dc79ecb1b93b69bfa58dbe554a5fe1e4156c/tifffile-2023.2.27.tar.gz
...
%prep
%setup -q -n tifffile-2023.2.27
cd %{_builddir}/tifffile-2023.2.27
pushd ..
cp -a tifffile-2023.2.27 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677601853
