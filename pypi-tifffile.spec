...
Source0  : https://files.pythonhosted.org/packages/8d/e5/c58f2dc22f6372516d1154ce1874c74cecf7c52892ad5f09bf3764b6b1b2/tifffile-2024.6.18.tar.gz
...
%prep
%setup -q -n tifffile-2024.6.18
cd %{_builddir}/tifffile-2024.6.18
pushd ..
cp -a tifffile-2024.6.18 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718824721
