...
Version  : 2022.10.10
Release  : 41
URL      : https://files.pythonhosted.org/packages/6e/a6/2ae17402253ae574f01a41b32572d0398f5bca3dd01dfc2bf8d12ce194f0/tifffile-2022.10.10.tar.gz
Source0  : https://files.pythonhosted.org/packages/6e/a6/2ae17402253ae574f01a41b32572d0398f5bca3dd01dfc2bf8d12ce194f0/tifffile-2022.10.10.tar.gz
...
%prep
%setup -q -n tifffile-2022.10.10
cd %{_builddir}/tifffile-2022.10.10
pushd ..
cp -a tifffile-2022.10.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665526229
...
cp %{_builddir}/tifffile-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tifffile/255833ee74469ee5a2f86e0a3c11ef1e4de4c2de || :
