...
Source0  : https://files.pythonhosted.org/packages/54/48/684c73f4db1e44068ea58609a2bd93c5cc6b74adc9a9891691605bf1597a/tifffile-2021.8.8.tar.gz
...
%prep
%setup -q -n tifffile-2021.8.8
cd %{_builddir}/tifffile-2021.8.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629141765
...
cp %{_builddir}/tifffile-2021.8.8/LICENSE %{buildroot}/usr/share/package-licenses/tifffile/7932e1a073ab773e326ed35b6b83cc80e5f03322
